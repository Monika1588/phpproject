...
<head>
    ...
    <style>
        body { background: #e3f2fd; font-family: 'Arial', sans-serif; }
        .header { background: black; color: white; padding: 15px; text-align: center; position: relative; }
        ...
        <div class="row g-4">
            <div class="col-md-3">
                <div class="card p-4 text-center bg-primary text-white">
                    ...
                    <a href="manage_product.php" class="btn btn-light mt-2">Go</a>
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="card p-4 text-center bg-danger text-white">
                    ...
                    <h5>Manage Orders</h5>
                    <a href="manage_orders.php" class="btn btn-light mt-2">Go</a>
                </div>
            </div>
            <div class="col-md-3">
    <div class="card p-4 text-center bg-info text-white">
        <i class="fas fa-seedling"></i>
        <h5>Manage Plant Exchanges</h5>
        <a href="manage_exchanges.php" class="btn btn-light mt-2">Go</a>
    </div>
</div>
